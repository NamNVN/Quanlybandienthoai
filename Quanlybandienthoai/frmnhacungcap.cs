...
namespace Quanlybandienthoai
{
    public partial class frmnhacungcap : Form
    {
        ...
        {
            co.KetNoi();
            dgvncc.DataSource = co.GetData("select * from tblNhaCungCap");
            co.NgatKetNoi();
        }
        ...
        {
            string sqlthem = "insert into  tblNhaCungCap values ('" + txtmancc.Text + "','" + txttenncc.Text
        ...
        {
            string sqlsua = "update tblNhaCungCap set MaNCC='" + txtmancc.Text + "',TenNCC='" + txttenncc.Text
        ...
        private void btnxoa_Click(object sender, EventArgs e)
        {
           ...
           MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
            ...
            {
                string sqlxoa = "delete from tblNhaCungCap where MaNCC = '" + txtmancc.Text + "'";
                co.ThucThi(sqlxoa);
            }
            frmnhacungcap_Load(sender, e);
        }
