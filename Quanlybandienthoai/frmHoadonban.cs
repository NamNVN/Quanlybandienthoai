...
namespace Quanlybandienthoai
{
    public partial class frmHoadonban : Form
    {
        ...
        private void btnthem_Click(object sender, EventArgs e)
        {
            ...
            co.KetNoi();
            string sqlthem = "insert into tblHoadonban values ('" + txtmahoadonban.Text + "','" + cbomanv.Text + "','" + cbomakh.SelectedValue + "','" + cbomamaytinh.SelectedValue + "','" + txtsoluong.Text + "','" + mtbNgayban.Text + "','" + txtdiachi.Text + "','" + txtsodienthoai.Text + "','" + txtdongia.Text + "','" + txtTongtien.Text + "')";
            co.ThucThi(sqlthem);
        ...
        private void dgvDShdb_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            cbomanv.Text = dgvDShdb.Rows[i].Cells[1].Value.ToString().Trim();
            ...
            mtbNgayban.Text = dgvDShdb.Rows[i].Cells[5].Value.ToString().Trim();
            ...
            txtTongtien.Text = dgvDShdb.Rows[i].Cells[9].Value.ToString().Trim();
        }
        ...
        private void btnsua_Click(object sender, EventArgs e)
        {
            ...
            txtTongtien.Text = tongtien.ToString();
            co.KetNoi();
            string sqlsua = "update tblHoadonban set MaHDB='" + txtmahoadonban.Text + "',MaNV='" + cbomanv.Text +
                "',MaKH='" + cbomakh.SelectedValue + "',MaDT='" + cbomamaytinh.SelectedValue +
